...
public class PersistenceManager {
	...
	private final String userDir = "C:/DIS/";
	...
	private boolean writeToLog(int transactionID, PageData page)
	{
		try
		{
			...
			File logFile = new File(String.format(userDir + "/log/%s.log", page.getPageID()));
			FileWriter fw = new FileWriter(logFile);
			fw.write(String.format("%d,%d,%d,%s", page.getLogSequenceNumber(), transactionID, page.getPageID(), page.getData()));
			fw.close();
			return true;
		}
		catch(Throwable e)
