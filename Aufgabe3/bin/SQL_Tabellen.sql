...
INSERT INTO immobilien (id_makler,  ort,       plz,     strasse,          haus_nr,  flaeche)
 ...
 * Wohnung + Immobilien
 */
CREATE VIEW immobilien_wohnung (id_immobilien, id_makler, ort, plz, strasse, haus_nr, flaeche, stockwerk, mietpreis, zimmer, balkon, ebk) AS 
 ...
 * Haus + Immobilien
 */
CREATE VIEW immobilien_haus (id_immobilien, id_makler, ort, plz, strasse, haus_nr, flaeche, stockwerk, kaufpreis, garten) AS 
	SELECT	immobilien.id,
			immobilien.id_makler,
			immobilien.ort,
			immobilien.plz,
